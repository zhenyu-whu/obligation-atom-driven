...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| T-001 | AC-001 | python3 references/agent-runtime/scripts/validate_tasks_quality.py tests/fixtures/tasks-quality/non_runtime_simple.md | tests/fixtures/tasks-quality/non_runtime_simple.md::schema-only | config/ops/check | RSI-NA OCM-NA SBM-NA ARC-NA | yes | static fixture only | not-applicable: source-backed docs-only | not-applicable: source-backed docs-only | not-applicable: source-backed docs-only | not-applicable: source-backed docs-only | python3 references/agent-runtime/scripts/validate_tasks_quality.py tests/fixtures/tasks-quality/non_runtime_simple.md | green-passed | none | test-results/non-runtime-simple/AC-001/T-001/ | validator pass | test-results/non-runtime-simple/AC-001/T-001/ledger.md | yes | docs-only fixture | proof-only | 不新增 runtime 行为 |

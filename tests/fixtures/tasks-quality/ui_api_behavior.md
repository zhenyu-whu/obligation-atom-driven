...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| T-001 | AC-001 | npm test -- apps/example/example-form.component.test.tsx | apps/example/example-form.component.test.tsx::renders validation and submit state | component | RSI-001 OCM-001 SBM-001 | component-user-flow | jsdom, no network | yes | npm test -- apps/example/example-form.component.test.tsx | submit state assertion fails before implementation | observed failing assertion for missing success state | npm test -- apps/example/example-form.component.test.tsx | green-passed | none | test-results/ui-api-behavior/AC-001/T-001/ | command.log, ledger.json, component test log | test-results/ui-api-behavior/AC-001/T-001/ledger.json | yes | SI-001 | required behavior | no scope expansion |
| T-002 | AC-001 | npm test -- apps/example/api/example-route.contract.test.ts | apps/example/api/example-route.contract.test.ts::post returns accepted contract | route/API contract | RSI-001 OCM-001 ARC-001 | route-handler-real-service | in-process route handler, no external service | yes | npm test -- apps/example/api/example-route.contract.test.ts | accepted contract fails before implementation | observed 404 before implementation | npm test -- apps/example/api/example-route.contract.test.ts | green-passed | T-001 | test-results/ui-api-behavior/AC-001/T-002/ | command.log, ledger.json, route contract log | test-results/ui-api-behavior/AC-001/T-002/ledger.json | yes | SI-001 | required behavior | no scope expansion |
| T-003 | AC-001 | npx playwright test tests/e2e/example-form.spec.ts | tests/e2e/example-form.spec.ts::user submits default path | browser E2E | RSI-001 OCM-001 SBM-001 ARC-001 | browser-e2e | local app server only | yes | npx playwright test tests/e2e/example-form.spec.ts | confirmation not rendered before implementation | observed missing confirmation | npx playwright test tests/e2e/example-form.spec.ts | green-passed | T-001 T-002 | test-results/ui-api-behavior/AC-001/T-003/ | command.log, ledger.json, browser trace and screenshot | test-results/ui-api-behavior/AC-001/T-003/ledger.json | yes | SI-001 | required behavior | no scope expansion |

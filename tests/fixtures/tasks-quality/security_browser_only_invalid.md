...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| AC-001 | T-001 | tests/e2e/admin-items.spec.ts | npx playwright test tests/e2e/admin-items.spec.ts | admin creation works in browser | rendered item appears | local app server only | local/CI | API/DB/security low-level contracts | deposited |

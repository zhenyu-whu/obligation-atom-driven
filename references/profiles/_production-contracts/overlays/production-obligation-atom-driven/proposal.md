...
- `foundation-reference-read-set` 只能记录 reference path、trace path、digest 和 read purpose。不得记录 consumed/materialized/deferred/not-applicable foundation atoms，不得传播 foundation `GA-####` 到 specs/runtime/proof/tasks coverage。

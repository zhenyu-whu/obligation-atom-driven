...
- <!-- 用户/系统可观察的验收结果。必须能从 proposal/spec/design/runtime-acceptance 推导，不从实现计划反推，不列 SI coverage。 -->
...
- <!-- worker 可执行的 production change 范围；不要放 provider/consumer graph、SI coverage 或测试计划。 -->

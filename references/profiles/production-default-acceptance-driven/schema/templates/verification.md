...
manual / not-applicable 必须通过对应 runtime row 的 scope role、default path、external boundary 或 no-scope boundary 解释。
-->
...
| --------------- | --------------------------------------------------------------- | --------------------------------------------------------------------------- | --------------------------------- | ------------------------------- | -------------------------------------------------------------- | ---------------------------------------------------------------------- |
| <!-- OP-001 --> | <!-- required / preserve / proof-only / no-scope / external --> | <!-- primary / supporting / preserve / proof-only / no-scope / external --> | <!-- PS-001, PS-002 或 None。 --> | <!-- None 或缺失的 PS-###。 --> | <!-- covered / partial / manual / not-applicable / blocked --> | <!-- None；或 scope-backed/manual/environment/not-covered reason。 --> |
...
- [ ] 没有在 verification.md 中新增 scope basis 或重新解释 scope。

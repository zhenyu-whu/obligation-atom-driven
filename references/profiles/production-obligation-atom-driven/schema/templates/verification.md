...
不得用一个 slice 覆盖 edit/add/delete、success/failure/empty、hit/mismatch、unauthenticated/foreign/deleted、desktop/mobile、started/succeeded/failed/retried 等多个独立分支。

...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| <!-- RS-001 --> | <!-- UI route / client component / API / DB / worker / queue / SSE / storage / auth / config 等。 --> | <!-- module/component/service owner candidate。 --> | <!-- route/action/job/stream entry。 --> | <!-- 该 surface 必须提供或保留的 runtime behavior。 --> | <!-- 可观察 rendered/API/DB/auth/log 等 fact。 --> | <!-- production/default path 是否必须真实及理由。 --> | <!-- provider/storage/network/env 等边界。 --> | <!-- GA-0001 / spec scenario / design obligation。 --> | <!-- projection。 --> | <!-- required behavior / preserve boundary / proof-only / not applicable。 --> | <!-- 不引入 source 外 surface。 --> |
